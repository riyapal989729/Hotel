                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-12 col-md-3 bg-success  text-center">
                            <a href="addproperty.php"><span class="mt-1 bg-success btn fs-5"> <i class="fa fa-user-plus "></i> Add property </span></a> 
                        </div>
                    </div>        
                </div>
                <div class="container-fluid">
                <div class="row border">   
                    ...
                    <table id="example" class="display" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $i++ ?></td>
                                <td><?php echo $row['addproperty'] ?></td>
                                ...
                                <td>
                                    ...
                                    <a href="addproperty.php?id=<?php echo $row['id']?>"><i class="fa fa-edit"></i></a>
